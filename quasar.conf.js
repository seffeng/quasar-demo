...
module.exports = function(/* ctx */) {
  return {
    ...
    htmlVariables: {
      ...
      keyword: process.env.VUE_APP_WEB_KEYWORD || '',
    ...
    pwa: {
      ...
      manifest: {
        name: process.env.VUE_APP_WEB_TITLE,
        short_name: process.env.VUE_APP_WEB_NAME,
        description: process.env.VUE_APP_WEB_DESCRIPTION,
        display: 'standalone',
    ...
    electron: {
      ...
      builder: {
        ...
        appId: process.env.VUE_APP_WEB_NAME || 'quasar-demo'
      },
